...
architecture STRUCTURE of design_1_VGA_0_0_VGA is
  ...
  attribute SOFT_HLUTNM of \bg_blue[1]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \bg_blue[2]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \bg_blue[3]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \bg_blue[3]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \bg_blue[3]_i_5\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \bg_blue[3]_i_6\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \bg_blue[3]_i_7\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \bg_green[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \bg_green[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \bg_green[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \bg_green[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \bg_red[3]_i_4\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of blank_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \frame_addr[18]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \h_cnt[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \h_cnt[11]_i_4\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \v_cnt[0]_i_3\ : label is "soft_lutpair4";
...
\bg_blue[3]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\bg_blue[3]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EEE0"
    )
        port map (
...
\bg_blue[3]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\bg_green[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A3A0"
    )
        port map (
...
\bg_green[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A3A0"
    )
        port map (
...
\bg_green[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A3A0"
    )
        port map (
...
\bg_green[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A3A0"
    )
        port map (
...
\bg_red[3]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
blank_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\frame_addr[18]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000057"
    )
        port map (
...
\frame_addr[18]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\frame_addr[18]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\frame_addr_reg[18]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2) => \frame_addr[18]_i_5_n_0\,
      S(1) => \frame_addr[18]_i_6_n_0\,
      S(0) => \frame_addr[18]_i_7_n_0\
    );
...
h_sync_d_reg_srl2_i_4: unisim.vcomponents.LUT6
    generic map(
...
\v_cnt[0]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
